// lib/api/push.js - Notificaciones push para Google Wallet + Apple Wallet (APNs) - MIGRADO A FIRESTORE
...
console.log('[PUSH] ✅ Configurado para Firestore');
...
async function fsGetNotificationsHistory(limit = 50) {
  try {
    ...
    console.error('[PUSH] Error obteniendo historial:', error);
    return [];
  }
}
