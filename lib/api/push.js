// api/push.js - Endpoints para notificaciones push a Wallets
import { updateLoyaltyObject, getWalletAccessToken } from '../lib/google.js';
...
/* =========================================================
   CREAR TABLA DE NOTIFICACIONES (ejecutar una vez)
   ========================================================= */
  ...
  try {
    ...
    for (const card of cards) {
      try {
        ...
        // TODO: Apple Wallet push notifications
        // if (card.apple_serial) {
        //   await sendApplePushNotification({
        //     serialNumber: card.apple_serial,
        //     title,
        //     message
        //   });
        //   appleSent++;
  ...
  try {
    ...
    if (!card) {
      return res.status(404).json({
        success: false,
        error: 'No se encontró tarjeta de prueba'
      });
    }
