...
router.post('/sales', async (req, res) => {
  try {
    ...
    // Get default tax rate from first product or use 0.16
    const avgTaxRate = 0.16;
    const tax = Math.round(subtotal * avgTaxRate * 100) / 100;
...
// GET /api/pos/sales — list sales with filters
