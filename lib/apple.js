...
function buildTempModelDir({
  ...
  // Solo crear fallbacks esenciales
  writeFileEnsured(path.join(dir, "stampw.png"), TRANSPARENT_PNG);
  writeFileEnsured(path.join(dir, "logow.png"), TRANSPARENT_PNG);
...
/* =========================================================
   GENERADOR PRINCIPAL DE PASE APPLE
   ========================================================= */
export async function buildApplePassBuffer({ cardId, name, stamps, max }) {
  try {
    ...
    // 5. AGREGAR IMÁGENES Y STRIP DINÁMICO
    ...
    await addProcessedImage("logow.png", IMAGE_PATHS.logo, "logo");
    await addProcessedImage("logow@2x.png", IMAGE_PATHS.logo, "logo");
    await addProcessedImage("stamp.png", IMAGE_PATHS.icon, "icon");
    await addProcessedImage("stamp@2x.png", IMAGE_PATHS.icon, "icon");
