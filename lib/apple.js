...
function buildTempModelDir({
  ...
  const passJson = {
    ...
    coupon: {
      // VACÍO - Sin primaryFields para que NO haya texto gigante
      primaryFields: [],
      
      // Nombre y sellos en secondaryFields (tamaño MEDIANO debajo del strip)
      secondaryFields: [
        {
          key: "name",
          label: "CLIENTE",
      ...
      // Programa en auxiliaryFields (pequeño)
      auxiliaryFields: [
        {
          key: "program",
          label: "PROGRAMA",
