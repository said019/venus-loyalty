...
// PNG 1x1 placeholder (Apple exige iconos, aunque sean mínimos)
...
function buildTempModelDir({
  ...
  // Colores de la marca
  // #8c9668 (verde fuerte) -> rgb(140,150,104)
  // #fff6e3 (beige claro para texto) -> rgb(255,246,227)
  const backgroundColor = "rgb(140,150,104)";
  const foregroundColor = "rgb(255,246,227)";
  const labelColor = "rgb(255,246,227)";
...
export async function buildApplePassBuffer({ cardId, name, stamps, max }) {
  try {
    ...
    // 2) Modelo con los datos de esta tarjeta
