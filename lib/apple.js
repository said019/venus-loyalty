...
/* =========================================================
   Función principal: genera el .pkpass
   ========================================================= */
export async function buildApplePassBuffer({ cardId, name, stamps, max }) {
  try {
    ...
    // 3) Crear el PKPass desde el modelo
    ...
    function addImg(slot, filePath) {
      ...
      try {
        ...
        // El segundo parámetro DEBE ser solo el nombre, no una ruta
    ...
    // Logo e ícono (puedes apuntar estas env vars a public/assets/logo.png, etc.)
