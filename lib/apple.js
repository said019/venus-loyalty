...
export async function buildApplePassBuffer({ 
  ...
  pass.auxiliaryFields.push({
    ...
    label: "📢 Último Aviso",
    value: data.latestMessage,
    changeMessage: "Nuevo mensaje: %@" // ⭐ Apple mostrará esto como notificación
  });
  
  console.log(`[APPLE PASS] 🔔 Incluyendo mensaje en pase: "${data.latestMessage}"`);
}
  try {
