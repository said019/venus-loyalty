...
async function fsUnregisterDevice(deviceId, passTypeId, serialNumber) {
  try {
    ...
    // Si el registro no existe, no es un error que deba detener el proceso.
...
function checkAuth(req, res) {
  ...
  // Logueamos solo una parte del token para depuración
  ...
  const token = authHeader.substring('ApplePass '.length).trim(); // Usar la longitud de la cadena
