...
/* =========================================================
   ENVIAR NOTIFICACIÓN PUSH APNs (CORREGIDA PARA SILENCIOSA)
   ========================================================= */
  ...
  try {
    ...
    return new Promise((resolve, reject) => {
      ...
      const req = client.request({
        ...
        'apns-push-type': 'background', // ✅ CAMBIO: Usar 'background'
        'apns-priority': '5',            // ✅ CAMBIO: Usar prioridad 5 para background
...
export async function getUpdatablePassesHandler(req, res) {
  ...
  // ⭐ AUTH INLINE - QUITADO: Esta ruta no requiere AUTH para que el iPhone actualice.
  // if (!checkAuth(req, res)) return;
