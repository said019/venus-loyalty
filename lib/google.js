...
export async function createLoyaltyClass() {
  try {
    ...
    const loyaltyClass = {
      ...
      // Logo Venus (tu logo real - sube a un hosting público)
      programLogo: {
        sourceUri: {
      ...
      hexBackgroundColor: "#9A9F82", // Verde Venus (rgb(154, 159, 130))
      ...
      // Imagen de hero opcional (banner superior)
      heroImage: {
        sourceUri: {
...
export async function updateLoyaltyObject(cardId, name, stamps, max) {
  try {
    ...
    const loyaltyObject = {
      ...
      // Imagen de strip con los sellos (si existe)
      imageModulesData: [
        {
          id: "stamp_progress",
          mainImage: {
